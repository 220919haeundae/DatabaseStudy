...
-- 샘플 3개정도 생성 => 데이터 추가(DML - INSERT)
INSERT INTO TB_PUBLISHER VALUES (1, '민음사', '070-1234-5678');
INSERT INTO TB_PUBLISHER VALUES (2, '문학동네', '010-9090-1234');
INSERT INTO TB_PUBLISHER VALUES (3, '동아', '02-9090-3939');

SELECT * FROM TB_PUBLISHER ORDER BY PUB_NO;
...
CREATE TABLE TB_BOOK (
    ...
    -- , CONSTRAINT BOOK_FK FOREIGN KEY (BK_PUB_NO) REFUERENCES ON DELETE CASCADE ~ 
);
-- * 각 컬럼마다 설명 추가
...
INSERT INTO TB_BOOK VALUES (103, '다빈치 코드', '김인창', 50000, 2);
